            ...
            <div class="col-sm-8 mx-auto">
                ...
                <div class="card-body">
                    <form action="{{route('admin.admins.edit', [$admin->id])}}" method="post">
                        @csrf
                        <input type="hidden" id="editAdminId" value="{{ $admin->id }}" name="id">
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <select class="selectpicker form-control" name="role" id="role" data-style="py-0" required>
                                    @if(isset($admin->role))
                            ...
                            <select class="selectpicker form-control" name="status" id="editStatus" data-style="py-0" required>
