...
<head>
   ...
   <title>Edit Package | ZaumaData</title>
          ...
          <div class="row">
            <div class="col-sm-8 mx-auto">
              <div class="card">
                ...
                <div class="card-body">
                  <form action="{{route('admin.packages.edit')}}" method="post">
                      @csrf
                      <input type="hidden" name="id" id="editServiceId" value="{{$package->id}}">
                      <div class="row">
                        <div class="form-group col-md-12">
                            <label class="form-label" for="fname">Title:</label>
                            <input type="text" class="form-control" name="title" id="title" value="{{ $package->title }}" required>
                            @error('title')
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control" name="provider" required>
                              <option>{{isset($package->provider)?$package->provider: 'Choose..'}}</option>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select id="billerSelect" class="form-control" name="billerID">
                              @if(isset($package->billerID))
                                <option value="{{ $package->billerID }}">{{ $package->biller->title}}</option>
                              @else
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select id="serviceSelect" class="form-control" name="service" required>
                              <option>{{isset($package->service)?$package->service: 'Choose..'}}</option>
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <select id="planType" class="form-control" name="planType">
                            @if(isset($package->planType))
                              <option value="{{ $package->planType }}">{{ $package->planType}}</option>
                            @else
                              <option value="">Choose..</option>
                            @endif
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control" name="cost" id="cost" value="{{ $package->cost }}" required>
                            @error('cost')
                            <span class="text-danger small">{{ $message}}</span>
                            @enderror
                        </div>
                        <div class="form-group col-md-6">
                          ...
                          <input type="number" class="form-control" name="price" id="price" value="{{ $package->price }}" required>
                          @error('price')
                          <span class="text-danger small">{{ $message}}</span>
                          @enderror
                        </div>
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" name="size" id="size" value="{{ $package->size }}" >
                            @error('size')
                            <span class="text-danger small">{{ $message}}</span>
                            @enderror
                        </div>
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" name="validity" id="validity" value="{{ $package->validity }}" />
                            @error('validity')
                                <span class="text-danger small">{{ $message}}</span>
                            @enderror
                        </div>
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" id="plan" name="planID" value="{{ $package->planID }}" class="form-control" />
                            @error('planID')
                                <span class="text-danger small">{{ $message}}</span>
                            @enderror
                        </div>
                      </div>
                      <button type="submit" class="btn primary-btn" id="submitAddAdmin">Update Package</button>
                  </form>
                </div>
              </div>
            </div>
