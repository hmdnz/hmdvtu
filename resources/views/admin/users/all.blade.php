                  ...
                  <div class="row">
                      <div class="col-md-12">
                          <div class="flex-wrap d-flex justify-content-between align-items-center">
                              <div>
                                <h1>Users!</h1>
                                <p>List of all users on this platform</p>
                              </div>                            
                          </div>
                      </div>
                  </div>
              ...
              <div class="card">
                <div class="card-header d-flex justify-content-between">
                  <div class="header-title">
                    <h4 class="card-title">All Users ({{$userCount}})</h4>
                  </div>
                </div>
                      ...
                      <tbody id="users-table-body">
                          ...
                          @foreach($users as $user)
                              <tr>
                                  ...
                                  <td>
                                      <a href="{{ route('admin.users.view', [$user->id])}}" class="btn primary-btn px-2" >
