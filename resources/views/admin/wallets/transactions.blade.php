...
<head>
   ...
   <title>Wallet Transactions | ZaumaData</title>
                  ...
                  <div class="row">
                      <div class="col-md-12">
                          <div class="flex-wrap d-flex justify-content-between align-items-center">
                              <div>
                                <h1>{{$wallet->user->username}}'s Transaction</h1>
                  ...
                  <div class="table-responsive">
                    <table id="datatable" class="table table-striped" data-toggle="data-table">
                      ...
                      <tr>
                          ...
                          <th>{{formatPrice($transaction->balanceBefore, '₦', '2')}}</th>
                          <th>{{formatPrice($transaction->amount, '₦', '2')}}</th>
                          <th>{{formatPrice($transaction->balanceAfter, '₦', '2')}}</th>
