               ...
               <li class="nav-item dropdown">
                    <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <div class="caption ms-3 d-none d-md-block ">
                            ...
                            <p class="mb-0 caption-sub-title">&#8358; <span class="wallet-balance">{{ (is_null(auth()->user()->wallet)) ? '0.00' : number_format(auth()->user()->wallet->mainBalance, 2, '.', ',') }}</span></p>
                        </div>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="{{route('user.profile')}}">Edit Profile</a></li>
                        <li><a class="dropdown-item" href="{{route('user.show.password')}}">Edit Password</a></li>
                        <li><a class="dropdown-item" href="{{route('user.show.pin')}}">Edit Pin</a></li>
                        <li><a class="dropdown-item" href="{{route('user.show.logs')}}">My Logs</a></li>
                        <li>
