        ...
        <div class="conatiner-fluid content-inner mt-n5 py-0">
            <div class="row">
                <div class="col-md-8 mx-auto py-5" >
                        ...
                        <div class="card  border mt-5">
                            <div class="card-header ">
                                <div class="header-title text-center">
                                    <img class="rounded-circle" src="{{ asset('main/img/logo-hr.png') }}" width="100" height="50">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    @if($order->service == 'Bulk SMS')
                                        <li class="list-group-item d-flex justify-content-between">
                                            ...
                                            <div>
                                                <b>SenderID:</b> <span >{{$order->sender}}</span>
                                            </div>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between">
                                            <div>
                                                <b>Message:</b><span>{{$order->message}}</span>
                                            </div>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between">
                                            <div>
                                    ...
                                    @if($order->service == 'Electricity')
                                        ...
                                        <li class="list-group-item d-flex justify-content-between">
                                            <div>
                                                <b>Meter Type : </b> <span >{{$order->meterType}}</span>
                                            </div>
                                            <div>
                                                <b>Meter No. : </b><span id="amount">{{$order->meterNumber}}</span>
                                            </div>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between">
                                            <div>
                                    ...
                                    @if($order->service == 'Cable')
                                        <li class="list-group-item d-flex justify-content-between">
                                            <div>
                                                <b>Biller : </b><span>{{$order->biller->title}}</span>
                                            </div>
                                            <div>
                    ...
                    <center>
                        <button class="btn secondary-btn" onclick="printContent('viewOrderInfo');">Print</button>
                        <button class="btn secondary-btn" id="btnPrint">Save</button>
                    </center>
                </div>
            </div>
        </div>
