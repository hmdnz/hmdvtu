...
<head>
   <meta charset="utf-8">
    ...
    <title>Buy Airtime | ZaumaData</title>
    <!-- Favicon -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="flex-wrap d-flex justify-content-between align-items-center">
                                <div>
                                    <h1>Buy Airtime </h1>
                                    <p>We have the cheapest airtime rate</p>
                                </div>
                                <div>
            ...
            <div class="row">
                ...
                <div class="col-md-9 mx-auto">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="container">
                                <form id="airtime-topup-form" method="post">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="number" name="amount" class="form-control" id="amount-airtime" required>
                                            @error('amount')
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" name="number" class="form-control" id="numbers" required />
                                            {{-- <a type="button" id="selectContactButton" class="text-primary small float-end">Select From Contacts</a> --}}
                                            @error('number')
                                            <span class="text-danger small">{{ $message}}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control" name="package" id="newPackage" required>
                                                <option selected value="">Choose..</option>
                                            </select>
                                            @error('package')
                                            <span class="text-danger small">{{ $message}}</span>
                                        ...
                                        <input type="hidden" name="category" class="form-control" id="category" value="VTU" required>
                                    ...
                                    <button type="submit" class="secondary-btn col-12" id="buy-airtime-button" >
                                        <i id="buyAirtimeButtonIcon" class="fa"></i>
                                        <span id='buyAirtimeButtonLoading'>Recharge</span>                                     
                                        <span id="total-span"></span></button>
                                </form>
                            </div>
                        </div>
                    </div>
...
{{-- airtime js --}}
<script src="{{ asset('app/assets/js/app/airtime.js') }}"></script>
</body>
</html>
