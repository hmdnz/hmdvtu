...
<head>
   <meta charset="utf-8">
    ...
    <title>Buy Data | ZaumaData</title>
    <!-- Favicon -->
            ...
            <div class="row">
                <div class="col-sm-9 mx-auto">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="container">
                                <form id="data-topup-form" method="post">
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="hidden" name="amount" class="form-control" id="amount" required>
                                    ...
                                    <button type="submit" class="btn secondary-btn col-12" id="buy-data-button" >
                                        <i id="buyDataButtonIcon" class="fa"></i>
                                        <span id='buyDataButtonLoading'>Recharge</span> 
                                        (Cost: &#8358;                                    
...
{{-- data js --}}
<script src="{{ asset('app/assets/js/app/data.js') }}"></script>
</body>
</html>