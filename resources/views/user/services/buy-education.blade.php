...
<head>
   <meta charset="utf-8">
    ...
    <title>Buy Education Pin | ZaumaData</title>
    <!-- Favicon -->
            ...
            <div class="col-md-8 mx-auto">
                ...
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Buy Education Pin</h4>
                    </div>
                </div>
                <div class="card-body">
                    <div class="container">
                        <form id="airtime-topup-form">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label class="form-label" for="exam">Select Exam</label>
                                ...
                                <div class="form-group col-md-120" style="display: none;" id="packageContainer">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="password" class="form-control" maxlength="4" id="pin" required />
                                    <span id="pin-message" class="text-danger"></span>
                                </div>
                            </div>
                            
                            <center>
                                <button type="submit" style="display:none"  id="buy-education-button" class="btn btn-primary col-12" onclick="processBuyEducation(event)"><span id='buyEducationButtonpaySpan'></span> Generate Token </button>
                            </center>
                        </form>
                        <center>
                            <div id="successFull" class="topup-success-message text-center" style="display: none;">
                                <div class="checkmark">
                                ...
                                <div class="topup-message">
                                    ...
                                    <p class="message-content">You have purchased education pin.</p>
                                </div>
                            </div>
                        </center>
                    </div>
