...
<head>
   <meta charset="utf-8">
    ...
    <title>Buy Electricity | ZaumaData</title>
    <!-- Favicon -->
                        ...
                        <div class="col-md-12">
                            <div class="flex-wrap d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <p>We have the cheapest electricity tokens</p>
                                </div>
                                <div>
        ...
        <div class="conatiner-fluid content-inner mt-n5 py-0">
            <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="container">
                            <form action="{{route('user.electricity')}}" method="post">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <select class="form-control" id="disco" name="disco" required>
                                            <option value="">Select..</option>
                                            <option value="01">Eko Electricity - EKEDC(PHCN)c</option>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" name="meterNo" id="meterNo" required/>
                                        @error('meterNo')
                                        <span class="text-danger small">{{ $message}}</span>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-12">
                                        ...
                                        <select class="form-control" name="meterType" id="meterType" required>
                                            <option value="">Select..</option>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="password" class="form-control" name="pin" maxlength="4" id="pin" required />   
                                        @error('pin')
                                        <span class="text-danger small">{{ $message}}</span>
                                        @enderror
                                        <input type="hidden" name="packageName" class="form-control" id="packageName">
                                        <input type="hidden" name="package" class="form-control" id="package">                       
                                        <input type="hidden" name="total" class="form-control" id="total">
                                    </div>
                                </div>
                                <center>
                                <button id="buy-Electricity-button" type="submit" class="btn secondary-btn" onclick="processBuyElectricity(event)"><span id='buyElectricityButtonSpan'></span>Generate Token <span id="totalSpan"></span></button></center>
                            </form>
...
{{-- electricity js --}}
<script src="{{ asset('app/assets/js/app/electricity.js') }}"></script>
