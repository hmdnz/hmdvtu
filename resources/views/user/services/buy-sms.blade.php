...
<head>
   <meta charset="utf-8">
    ...
    <title>Send Bulk SMS | ZaumaData</title>
    <!-- Favicon -->
          ...
          <div class="row">
            <div class="col-md-9 mx-auto">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="container">
                    <form id="sms-form"  action="{{route('user.sms')}}" method="post">
                      @csrf
                      ...
                      <div class="row">
                        <div class="form-group col-md-12">
                          ...
                          <input type="text" class="form-control" name="senderID" id="sender" placeholder="ex: Ahmad" required>
                          @error('senderID')
                        ...
                        <div class="form-group col-md-12">
                          ...
                          <textarea class="form-control" rows="2" name="numbers" id="numbers" required></textarea>
                          @error('numbers')
                          <span class="text-danger small">{{ $message}}</span>
                          @enderror
                        </div>
                        <div class="form-group col-md-12">
                          ...
                          <textarea class="form-control" name="message" rows="3" id="sms-message" required></textarea>
                          @error('message')
                          <span class="text-danger small">{{ $message}}</span>
                          @enderror
                        </div>               
                        <input type="hidden" name="packageName" class="form-control" id="packageName" required>
                        <input type="hidden" name="package" class="form-control" id="package" required>                       
                      ...
                      <button type="submit" id="buy-sms-btn" class="btn secondary-btn col-12"><span id='buySMSButtonSpan'></span>Send <span id="totalSpan"></span>
                      </button>
                    </form>
                  </div>
...
{{-- sms js --}}
<script src="{{ asset('app/assets/js/app/sms.js') }}"></script>
