                      ...
                      <div class="col-md-12">
                        <div class="flex-wrap d-flex justify-content-between align-items-center">
                          <div>
                            ...
                            <button id="copy-wallet-id" class="btn btn-link secondary-btn wallet-id btn-sm">
                              <span class="wallet-id-text" style="color: #fff;">Wallet ID: <span id="walletIdentifierSpan">{{ (is_null(auth()->user()->wallet)) ? 'Unknown' : auth()->user()->wallet->identifier }}</span></span>
                          ...
                          <div>
                            <div class="d-flex align-items-center">
                              ...
                              <a href="{{route('user.walletTopUp')}}" class="btn secondary-btn ml-3">
                                <i class="fa fa-credit-card"></i>
                                Fund Wallet
                              </a>&nbsp;
                              {{-- <button id="transfer-funds" class="btn btn-secondary ml-3" type="button" data-toggle="modal" data-target="#transferModal">
                      ...
                      <table id="datatable" class="table table-striped" data-toggle="data-table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <th>&#8358; {{number_format($transaction->balanceBefore, 2, '.', ',')}}</th>
                            <th>&#8358; {{number_format($transaction->amount, 2, '.', ',')}}</th>
                            <th>&#8358; {{number_format($transaction->balanceAfter, 2, '.', ',')}}</th>
